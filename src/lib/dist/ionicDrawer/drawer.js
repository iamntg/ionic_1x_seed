(function() {
  ...
  .controller('drawerCtrl', ['$element', '$attrs', '$ionicGesture', '$ionicScrollDelegate', '$timeout', '$document',
    function($element, $attr, $ionicGesture, $ionicScrollDelegate, $timeout, $document) {
  ...
  .directive('drawer', ['$rootScope', '$ionicGesture', '$ionicBackdrop',
    function($rootScope, $ionicGesture, $ionicBackdrop) {
      return {
        restrict: 'E',
  ...
  .directive('drawerClose', ['$rootScope',
    function($rootScope) {
      return {
        restrict: 'A',
